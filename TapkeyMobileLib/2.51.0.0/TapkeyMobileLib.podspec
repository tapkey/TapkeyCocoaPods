Pod::Spec.new do |s|
    ...
    s.source = { :http => "https://cocoapods.tapkey.com/TapkeyMobileLib/2.51.0.0/TapkeyMobileLib-2.51.0.0.tar.bz2", :sha256 => "27fa794f078dcc0d26bfc1dc392657756a3f6dcae725c8a17a291691427a8d86"}
    s.platforms = { 
        :ios => "15.6",
        :watchos => "8.7"
    }
