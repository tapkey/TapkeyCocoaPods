Pod::Spec.new do |s|
    ...
    s.source = { :http => "https://cocoapods.tapkey.com/TapkeyMobileLib/2.46.16.0/TapkeyMobileLib-2.46.16.0.tar.bz2", :sha256 => "713c472c71e8f67f2cd159ecece0211324a8fdefc39e0f039b94bfa96b443ab7"}
    s.platforms = { 
        :ios => "13.0",
        :watchos => "6.2"
    }
