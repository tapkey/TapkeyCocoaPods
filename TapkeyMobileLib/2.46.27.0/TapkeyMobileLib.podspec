Pod::Spec.new do |s|
    ...
    s.source = { :http => "https://cocoapods.tapkey.com/TapkeyMobileLib/2.46.27.0/TapkeyMobileLib-2.46.27.0.tar.bz2", :sha256 => "3e4a24cc795a0c984a1f6d0bd72a871d1ec19eee6f53d97418ff14d7949d0151"}
    s.platforms = { 
        :ios => "13.0",
        :watchos => "6.2"
    }
