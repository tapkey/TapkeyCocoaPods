Pod::Spec.new do |s|
    ...
    s.source = { :http => 'https://tapkeyartifacts.blob.core.windows.net/tapkeyiosmobilelib/1.15.0.3/TapkeyMobileLib-1.15.0.3.tar.bz2'}
    s.platform         = :ios
    ...
    s.subspec 'TapkeyMobileLib' do |subspec|
        ...
        subspec.dependency 'J2ObjC/JreCore', '2.1.1-RC1'
        subspec.dependency 'J2ObjC/JreUtil', '2.1.1-RC1'
        subspec.dependency 'GsonJ2ObjC-Light', '2.3.1-RC1'
    end
