Pod::Spec.new do |s|
    ...
    s.source = { :http => "https://cocoapods.tapkey.com/TapkeyMobileLib/2.42.0.0/TapkeyMobileLib-2.42.0.0.tar.bz2", :sha256 => "d46c469a6b424d2280157933864be4fdcd1e76b66f5aa3d6aec307802e7fea7a"}
    s.platforms = { 
        :ios => "12.0",
        :watchos => "6.2"
    }
    ...
    s.subspec 'Core' do |cs|
        ...
        cs.dependency 'JRE', '2.9.1.0-tk'
        cs.dependency 'GsonJ2ObjC', '2.8.6.6'
