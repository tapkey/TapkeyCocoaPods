Pod::Spec.new do |s|
    ...
    s.source = { :http => "https://cocoapods.tapkey.com/TapkeyMobileLib/2.50.0.0/TapkeyMobileLib-2.50.0.0.tar.bz2", :sha256 => "64049d9dfafbb3b640f95ecf620e768aea22d18f49a3e004cc72f557cb5f1086"}
    s.platforms = { 
        :ios => "13.0",
        :watchos => "6.2"
    }
