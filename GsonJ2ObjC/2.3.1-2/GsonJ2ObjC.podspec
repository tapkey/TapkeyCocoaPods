Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://tapkeyartifacts.blob.core.windows.net/gsonj2objc/2.3.1-2/GsonJ2ObjC-2.3.1-2.zip'}
  ...
  s.dependency "J2ObjC/JreSql", '2.1.1-2'
  s.dependency "J2ObjC/JreNet", '2.1.1-2'
  s.dependency "J2ObjC/JreSecurity", '2.1.1-2'
